...
export default async function CustomersPage() {
  ...
  return <div className="page-wrap"><PageHeader eyebrow="Customer database" title="Customers" description="Contact information, project addresses, notes, estimates, and payment history." actions={<Link href="/customers/new" className="button button--gold">+ Add customer</Link>} />
