...
export default async function ArchivedEstimatesPage(){
 ...
 return <div className="page-wrap"><PageHeader eyebrow="Estimate storage" title="Archived estimates" description="Keep old bids and customer history without cluttering the active estimate list." actions={<Link className="button button--outline" href="/estimates">Back to estimates</Link>}/>
