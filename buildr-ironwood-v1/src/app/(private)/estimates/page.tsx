...
export default async function EstimatesPage({searchParams}:{searchParams:Promise<{status?:string}>}){
 ...
 return <div className="page-wrap"><PageHeader eyebrow="Proposals & bids" title="Estimates" actions={<div className="button-row"><Link className="button button--outline" href="/estimates/deleted">Trash</Link><Link className="button button--gold" href="/estimates/new">+ New estimate</Link></div>}/>
