...
export default async function EstimatesPage(){
 ...
 return <div className="page-wrap"><PageHeader eyebrow="Proposals & bids" title="Estimates" description="Write detailed scopes, price every line, send professional proposals, and track customer activity." actions={<div className="button-row"><Link className="button button--outline" href="/estimates/archived">Archived</Link><Link className="button button--outline" href="/estimates/deleted">Trash</Link><Link className="button button--gold" href="/estimates/new">+ New estimate</Link></div>}/>
